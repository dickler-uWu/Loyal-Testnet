...
echo -e '\e[33mProject =\e[37m' Testnet Loyal
...
if [ ! $LYL_NODENAME ]; then
	read -p "Nama Node Mu: " LYL_NODENAME
...
# Install Packages
echo -e "\e[1m\e[32m2. Install Packages... \e[0m" && sleep 1
...
# Download & Install Loyal Node
echo -e "\e[1m\e[32m1. Tunggu sebentar... \e[0m" && sleep 1
cd $HOME
...
# Konfigurasi Node
echo -e "\e[1m\e[32m1. Konfigurasi... \e[0m" && sleep 1
...
# Set Minimum Gas
sed -i -e "s/^minimum-gas-prices *=.*/minimum-gas-prices = \"0.01$LYL_DENOM\"/" $HOME/$LYL_FOLDER/config/app.toml
...
echo -e "\e[1m\e[32m4. Create Services... \e[0m" && sleep 1
# create service
